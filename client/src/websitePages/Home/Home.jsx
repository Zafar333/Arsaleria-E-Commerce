...
const Home = () => {
  ...
  return (
    <div className="max-w-[1400px] mx-auto">
      ...
      <div className="mt-[100px]">
        <p className="font-Roboto text-[40px] md:text-[64px] text-darkGreen text-center">Best Selling</p>
        {/* card Container*/}
        <div className="mt-[20px] md:mt-[50px] grid grid-cols-1 md:grid-cols-3 gap-[60px] md:gap-[20px] lg:gap-[40px]">
          ...
          <div className=" bg-grayGreen h-[400px] xl:h-[550px] rounded-sm" >
            <img src="./homepageImgs/7.webp" className="w-full h-full object-center md:object-cover lg:object-contain" />
          </div>
            {/* card text Content */}
          ...
          <Link href={`/productDetail/${2}`} className='cursor-pointer'>
          <div className=" bg-grayGreen h-[400px] xl:h-[550px] rounded-sm" >
            <img src="./homepageImgs/4.webp" className="w-full h-full object-center md:object-cover lg:object-contain" />
          </div>
            {/* card text Content */}
            <div className="mt-[10px]">
              <p className="font-Poppins text-[22px] text-center text-darkGray bolder font-bold">product name</p>
          ...
          <div className=" bg-skyBlue h-[400px] xl:h-[550px] rounded-sm" >
            <img src="./homepageImgs/2.webp" className="w-full h-full object-center md:object-cover lg:object-contain" />
          </div>
            {/* card text Content */}
            <div className="mt-[10px]">
              <p className="font-Poppins text-[22px] text-center text-darkGray bolder font-bold">product name</p>
        ...
        {/* card Container */}
          <div className="flex justify-center mt-[80px]"><Link  href={"#"} className="py-[10px] px-[60px] rounded-sm border border-darkGreen text-[22px] font-Poppins">See All</Link></div>
