...
const ProductDetailBuyNowButton = () => {
  ...
  return (
    <div>
    <Button className='w-[250px] xl:min-w-full !bg-darkGreen !text-white  !text-[18px] !sm:text-[20px] !font-Poppins !py-[20px] !px-[20px] sm:!px-[30px]' onClick={gotoCartPageFun}>Buy Now</Button>
