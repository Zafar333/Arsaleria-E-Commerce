         ...
         <div className='w-full h-screen px-2 xs:px-5 sm:px-10 md:px-20 xl:px-40 2xl:px-60 py-5 [@media(min-height:600px)]:py-10 [@media(min-height:700px)]:py-14 [@media(min-height:750px)]:py-24 grid grid-cols-[1fr_3fr]'>
            ...
            <div className='px-2 sm:px-5 md:px-10 lg:px-20 py-14 [@media(min-height:700px)]:py-24 bg-gray-50 shadow-md'>
                <div className='text-center mt-2 mb-8'>
                    <p className='text-[25px] sm:text-[30px] md:text-[40px] font-Poppins text-darkGreen '>SIGNUP</p>
                </div>
                <Form
                    className=''
                    layout='vertical'
                ...
                >
                    ...
                    <div className='mt-4 flex flex-col gap-4 '>
                        {loading == false ? (
                            <Button type='primary' htmlType="submit" className='w-full bgClr bg-darkGreen! text-white! text-[16px]! sm:text-[18px]! py-[20px]! font-Poppins! hover:bg-darkGreen! focus:bg-darkGreen! active:bg-darkGreen!'>
                                SIGNUP
                            </Button>) : (
                            <Button type='primary' className='w-full bgClr bg-darkGreen! text-white! text-[18px]! py-[20px]! font-Poppins! hover:bg-darkGreen! focus:bg-darkGreen! active:bg-darkGreen!'>
                        ...
                        <p className='mt-[8px] text-center font-Poppins text-[25px] text-darkGreen'>or</p>

                    <div className='text-center mt-3'>
                        <p className='text-darkGreen cursor-pointer font-Poppins text-[14px] ' onClick={gotoLoginPage}>if you have account? login here</p>
                    </div>
                </Form>
