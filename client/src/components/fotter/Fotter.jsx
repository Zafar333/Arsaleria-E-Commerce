...
const Fotter = () => {
  return (
    <div className="mt-[100px] bg-darkGreen py-[40px] ">
      <div className="flex justify-center">
        <div className="w-[1400px] px-[50px] grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-[30px]">
          {/* <div className="flex flex-wrap gap-[30px] items-start px-[10px] sm:flex-row sm:justify-around border border-white"> */}
          {/* company info */}
          <div className="flex flex-col gap-[10px] ">
            <p className="text-[14px] sm:text-[16px] md:text-[18px] text-white font-Roboto underline">
              Company
            </p>
          ...
          {/* ContactUs  */}
          <div className="flex flex-col gap-[10px]">
            <label className="text-[14px] sm:text-[16px] md:text-[18px] text-white font-Roboto underline">
              Contact Us
            </label>
            <div className="flex gap-[10px] px-[12px] ">
              <AiOutlineMail className="text-[18px] text-lightGreen" />
              <div className="">
                <p className="font-Poppins text-[12px] sm:text-[14px] text-lightGreen">
                  Email
                </p>
                <p className="font-Poppins text-[9px] sm:text-[11px] text-lightGreen">
                  whitegolddairy@gmail.com
                </p>
              </div>
            </div>
            <div className="flex gap-[10px] px-[12px]">
              <FaLocationDot className="text-[18px] text-lightGreen" />
              <div className="">
                <p className="font-Poppins text-[12px] sm:text-[14px] text-lightGreen">
                  Address
                </p>
