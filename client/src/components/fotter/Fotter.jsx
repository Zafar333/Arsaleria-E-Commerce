  ...
  return (
    <div className="mt-[100px] bg-darkGreen py-[40px] ">
      <div className="flex justify-center">
        <div className="w-[1400px] px-[50px] grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
          {/* <div className="flex flex-wrap gap-[30px] items-start px-[10px] sm:flex-row sm:justify-around border border-white"> */}
          {/* ContactUs  */}
          <div className="flex flex-col gap-[10px]">
            <label className="text-[16px] sm:text-[18px] md:text-[22px] text-white font-Roboto underline">
              Contact Us
            </label>
          ...
          {/* company info */}
          <div className="flex flex-col gap-[10px] ">
            <p className="text-[16px] sm:text-[18px] md:text-[22px] text-white font-Roboto underline">
              Company
            </p>
