...
const UserLogin = ({isLoginModalOpen,setIsLoginModalOpen,setIsSignUpModalOpen,isSignUpModalOpen}) => {
...
<Modal className='h-[500px]' open={isLoginModalOpen} onOk={handleOk} footer={false} onCancel={handleCancel}>
    ...
    <div  className='flex flex-col gap-3'>
      ...
      <Button className='bg-black text-white text-[20px] font-Poppins py-[20px]' > <LoadingOutlined className='text-lightGreen text-[24px] ' spin /></Button>
       ...
       <div className='text-center mt-4'> 
        <label className='text-darkGreen cursor-pointer font-Poppins' onClick={openSignupModal }>New here? SignUp</label>
        </div>
  </Form>
  </div>
  </Modal>
